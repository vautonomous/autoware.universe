...
def generate_launch_description():
    ...
    camera_param_path = "/home/volt/projects/autoware/src/sensor_component/external/lucid_vision_driver/param/right_camera.param.yaml"
    ...
    container = ComposableNodeContainer(
        ...
        composable_node_descriptions=[
            ...
            ComposableNode(
                ...
                name='rectify_right_camera_image_node',
                # Remap subscribers and publishers
                remappings=[
                    ('image', input_image),
                    ('camera_info', input_camera_info),
                    ('image_rect', 'image_rect_right')
                ],
                extra_arguments=[
                    {"use_intra_process_comms": bool(use_intra_process)}
                ],
            ...
            ComposableNode(
                ...
                name="right_camera_tensorrt_yolo",
                parameters=[
                    {
